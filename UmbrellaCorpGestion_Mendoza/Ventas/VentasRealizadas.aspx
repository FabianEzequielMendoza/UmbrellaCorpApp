<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site1.Master" AutoEventWireup="true" CodeBehind="VentasRealizadas.aspx.cs" Inherits="UmbrellaCorpGestion_Mendoza.Ventas.ventasRealizadas" %>
            ...
            <div class=" box column is-half">
                <section class="section">
                    <div class="has-text-centered">
                        <h2 class="title">Ventas realizas</h2>
                        <hr class="has-background-primary" />
                        <h3 class="is-italic has-text-left">Lista de ventas realizadas</h3>
