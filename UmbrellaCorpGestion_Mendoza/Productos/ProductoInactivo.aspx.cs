...
{
    public partial class ProductoInactivo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                query = "SELECT Id AS ID, nombre AS Nombre_Materia, pu AS Precio, cantidad AS Cantidad " +
               "FROM Producto " +
               "WHERE activo='False'";
        ...
        {
            Response.Redirect("/Productos/ConsultaModificacionProducto.aspx");
        }
