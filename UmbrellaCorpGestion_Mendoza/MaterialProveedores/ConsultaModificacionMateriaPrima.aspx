<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site1.Master" AutoEventWireup="true" CodeBehind="ConsultaModificacionMateriaPrima.aspx.cs" Inherits="UmbrellaCorpGestion_Mendoza.MaterialProveedores.ConsultaModificacionMateriaPrima" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class=" box column is-half">
                <section class="section">
                    <div class="has-text-centered">
                        <h2 class="title">Consulta y Modificación de Materia Prima</h2>
                        <hr class="has-background-primary" />
                        <h3 class="is-italic has-text-left">Realice una búsqueda por nombre de Materia Prima y véalo en la tabla de consulta
                        </h3>
                        ...
                        <p class="control">
                            <span class="select">
                                <asp:DropDownList ID="DropDownList1" runat="server" CausesValidation="false" AutoPostBack="True">
                                    <asp:ListItem>Nombre de Materia</asp:ListItem>
                                </asp:DropDownList>
                            </span>
                        </p>
                ...
                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" OnClick="LinkButton1_Click">Ir a Materias inactivos</asp:LinkButton>
                ...
                <div class="buttons is-centered">
                    ...
                    <button type="button" id="BtnEditarMateria" runat="server" class="button is-info is-outlined" visible="False" causesvalidation="false" onclick="javascript:EditarMateria()" >Editar Materia</button>
    ...
    <div class="modal" id="modalEditarMateria">
        <div class="modal-background"></div>
        <div class="modal-card">
            <header class="modal-card-head">
                <p class="modal-card-title">Editar Materia</p>
                <button class="delete" aria-label="close"></button>
            </header>
            <section class="modal-card-body">
                <div class="is-centered px-3 pb-3" style="background-color: white;">
                    <asp:Label ID="Label2" runat="server" Text="Nombre de Materia Prima actual"></asp:Label>
                    <asp:TextBox ID="TBNombreMPActual1" CssClass="input" runat="server" ReadOnly="True"></asp:TextBox>
                    <asp:Label ID="Label3" runat="server" Text="Nuevo nombre de Materia Prima"></asp:Label>
                    <asp:TextBox ID="TBNombreMPNuevo" CssClass="input" runat="server" placeholder="Ingrese nombre"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredNombreMP" runat="server" ErrorMessage="" ControlToValidate="TBNombreMPNuevo" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ValidationGroup="materia">Campo requerido</asp:RequiredFieldValidator>
                    ...
                    <asp:TextBox ID="TBProveedorNuevo" CssClass="input" runat="server" placeholder="Ingrese proveedor"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredProveedor" runat="server" ErrorMessage="" ControlToValidate="TBProveedorNuevo" ForeColor="Red" SetFocusOnError="true" ValidationGroup="materia">Campo requerido</asp:RequiredFieldValidator>
                </div>
            </section>
            <footer class="modal-card-foot">
                <asp:Button ID="confirmarEdicion" CssClass="button is-success" runat="server" Text="Confirmar" CausesValidation="true" OnClick="confirmarEdicion_Click" ValidationGroup="materia" />
    ...
    <div class="modal" id="modalModificarPrecio">
        ...
        <div class="modal-card">
            ...
            <section class="modal-card-body">
                <div class="is-centered px-3 pb-3" style="background-color: white;">
                    <asp:Label ID="Label8" runat="server" Text="Nombre de Materia Prima actual"></asp:Label>
                    <asp:TextBox ID="TBNombreMPActual2" CssClass="input" runat="server" ReadOnly="True"></asp:TextBox>
            ...
            <footer class="modal-card-foot">
                <asp:Button ID="confirmarModificarPrecio" CssClass="button is-success" runat="server" Text="Confirmar" ValidationGroup="precio" CausesValidation="true" OnClick="confirmarPrecio_Click" />
    ...
    <div class="modal" id="modalModificarCantidad">
        ...
        <div class="modal-card">
            ...
            <section class="modal-card-body">
                <div class="is-centered px-3 pb-3" style="background-color: white;">
                    <asp:Label ID="Label9" runat="server" Text="Nombre de Materia Prima actual"></asp:Label>
                    <asp:TextBox ID="TBNombreMPActual3" CssClass="input" runat="server" ReadOnly="True"></asp:TextBox>
            ...
            <footer class="modal-card-foot">
                <asp:Button ID="confirmarModificarCantidad" CssClass="button is-success" runat="server" Text="Confirmar" ValidationGroup="cantidad" CausesValidation="true" OnClick="confirmarCantidad_Click" />
    ...
    <script type="text/javascript">
        function EditarMateria() {
            var elemento = document.querySelectorAll("#modalEditarMateria");
