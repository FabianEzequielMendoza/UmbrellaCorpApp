<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site1.Master" AutoEventWireup="true" CodeBehind="ProveedoresInactivos.aspx.cs" Inherits="UmbrellaCorpGestion_Mendoza.MaterialProveedores.ProveedoresInactivos" %>
            ...
            <div class=" box column is-half">
                <section class="section">
                    <div class="has-text-centered">
                        <h2 class="title">Proveedores Inactivos</h2>
                        <hr class="has-background-primary" />
                        <h3 class="is-italic has-text-left">Reactive a los proveedores de la siguiente tabla</h3>
                        <hr style="border-top: 1px dashed hsl(171, 100%, 41%)" />
                    </div>                  
                </section>
                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" OnClick="LinkButton1_Click">Ir a Proveedores Activos</asp:LinkButton>
